...
% function [X] = SelectPoints(image, N)
% 
%     % image dimensions
...
%     imagesc(image); 
%     axis off;
%     title('Click to select 4 homography points: None selected')
%     
...
%    
%         hold on
%         plot(x, y, 'Color', [1, 0, 0], 'Marker', 'o', 'MarkerSize', 10, ...
%              'MarkerFaceColor',[1, 0, 0])   
%         title(['Click to select 4 homography points - ', num2str(n), ... 
%                ' selected'])
%     end
%     
%     pause(1); close;
